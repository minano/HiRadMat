...
void BeamLoss(){
  ...
  int i = 0;
   ...
   const float eV= 1.60217662E-19; //eV to Joules
   const float rad=0.01; //1rad = 0.01Gy
   const float Mrad = 3E13; //1Mrad = 3E13 equivalent neutrons/cm2
